  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
            CREATE TABLE "unit_results" (
                ...
                "pullRequest" character varying NOT NULL,
                "statementCoverage" character varying NOT NULL,
                "functionCoverage" character varying NOT NULL,
                "branchCoverage" character varying NOT NULL,
                "lineCoverage" character varying NOT NULL,
